...
import { UsersRoles, AddUser } from '@/pages/admin/Users/index';
...
import { 
  ...
  ExamBuilderPage, 
  ExamResultsPage 
} from '@/pages/admin/Exams/index';

import { CareerTasks, Reviews, PointsLevels } from '@/pages/admin/Career/index';
